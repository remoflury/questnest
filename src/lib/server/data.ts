...
const seoData: (SeoProps & { uri: string })[] = [
	...
	},
	{
		...
		seoPageDescription:
			'Sign in into the ultimate app for unforgettable bingo moments with friends.',
	...
	},
	{
		...
		seoPageDescription:
			'Sign up for the ultimate app for unforgettable bingo moments with friends.',
	...
	},
	{
		...
		seoPageDescription:
			'Imprint of questnest, the app for unforgettable bingo moments with friends.',
	...
	},
	{
		...
		seoPageDescription:
			'Learn more about the privacy policy of questnest, the app for unforgettable bingo moments with friends.',
		seoKeywords: 'game, bingo, friends, group, app, challenges, imprint'
	},
	{
		uri: '/pricing',
